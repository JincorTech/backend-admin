...
return [
     ...
     */
    'engines'        => [
        'eloquent'   => Pimlie\DatatablesMongodb\Engines\MoloquentEngine::class,
        'query'      => Pimlie\DatatablesMongodb\Engines\MongodbQueryBuilderEngine::class,
        'collection' => Yajra\Datatables\Engines\CollectionEngine::class,

        'mongoquery' => Pimlie\DatatablesMongodb\Engines\MongodbQueryBuilderEngine::class,
        'moloquent' => Pimlie\DatatablesMongodb\Engines\MoloquentEngine::class,
    ],
    ...
    'builders'       => [
        ...
        Jenssegers\Mongodb\Query\Builder::class                => 'mongodb',
    ],
